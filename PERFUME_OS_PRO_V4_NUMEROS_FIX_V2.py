...
st.markdown(
    ...
    /* FIX KPI: evitar que Streamlit recorte importes con "..." */
    [data-testid="stMetricValue"]{
        font-weight:800!important;
        letter-spacing:-.04em!important;
        font-size:clamp(1.20rem,1.55vw,1.75rem)!important;
    ...
    @media (max-width: 1500px){
        ...
        [data-testid="stMetric"]{padding:14px 14px!important;}
    }
    @media (max-width: 1100px){
        [data-testid="stMetricValue"]{font-size:1.18rem!important;}
        [data-testid="stMetric"]{padding:12px 11px!important;}
    }
    div[data-testid="stDataFrame"]{
